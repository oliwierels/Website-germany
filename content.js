...
window.LVD_CONTENT = {
  ...
  de: {
    ...
    footer: {
      ...
      useCasesLabel: 'Leistungen',
      useCases: [['messe-roboter/', 'Messe-Roboter'], ['event-roboter/', 'Event-Roboter'], ['konferenz-roboter/', 'Konferenz-Roboter'], ['roboter-firmenfeier/', 'Roboter für Firmenfeiern'], ['roboter-weihnachtsfeier/', 'Roboter für Weihnachtsfeiern'], ['roboter-show/', 'Roboter-Show buchen'], ['roboter-festival/', 'Festivals & historische Feste'], ['unitree-g1-mieten/', 'Unitree G1 mieten']],
  ...
  en: {
    ...
    footer: {
      ...
      useCasesLabel: 'Services',
      useCases: [['messe-roboter/', 'Trade-fair robot'], ['event-roboter/', 'Event robot'], ['konferenz-roboter/', 'Conference robot'], ['roboter-firmenfeier/', 'Corporate party robot'], ['roboter-weihnachtsfeier/', 'Christmas party robot'], ['roboter-show/', 'Robot show'], ['roboter-festival/', 'Festivals & historic events'], ['unitree-g1-mieten/', 'Rent the Unitree G1']],
