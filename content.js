...
window.LVD_CONTENT = {
  ...
  de: {
    ...
    footer: {
      ...
      useCases: [['/messe-roboter/', 'Messe-Roboter'], ['/event-roboter/', 'Event-Roboter'], ['/konferenz-roboter/', 'Konferenz-Roboter'], ['/roboter-firmenfeier/', 'Roboter für Firmenfeiern'], ['/roboter-weihnachtsfeier/', 'Roboter für Weihnachtsfeiern'], ['/roboter-show/', 'Roboter-Show buchen']],
  ...
  en: {
    ...
    footer: {
      ...
      useCases: [['/messe-roboter/', 'Trade-fair robot'], ['/event-roboter/', 'Event robot'], ['/konferenz-roboter/', 'Conference robot'], ['/roboter-firmenfeier/', 'Corporate party robot'], ['/roboter-weihnachtsfeier/', 'Christmas party robot'], ['/roboter-show/', 'Robot show']],
