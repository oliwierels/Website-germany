...
window.LVD_CONTENT = {
  ...
  de: {
    ...
    footer: {
      ...
      occLabel: 'Nach Anlass',
      occasions: [['/event-roboter/messe/', 'Messe & Kongress'], ['/event-roboter/konferenz/', 'Konferenz & Tagung'], ['/event-roboter/firmenfeier/', 'Firmenfeier & Sommerfest'], ['/event-roboter/weihnachtsfeier/', 'Weihnachtsfeier'], ['/event-roboter/produktpraesentation/', 'Produktlaunch'], ['/event-roboter/eroeffnung/', 'Eröffnung & Store Opening']],
      occAll: ['/event-roboter/', 'Alle Anlässe'],
  ...
  en: {
    ...
    footer: {
      ...
      occLabel: 'By occasion',
      occasions: [['/event-roboter/messe/', 'Trade fairs & congresses'], ['/event-roboter/konferenz/', 'Conferences & summits'], ['/event-roboter/firmenfeier/', 'Company parties'], ['/event-roboter/weihnachtsfeier/', 'Christmas parties'], ['/event-roboter/produktpraesentation/', 'Product launches'], ['/event-roboter/eroeffnung/', 'Grand openings']],
      occAll: ['/event-roboter/', 'All occasions'],
